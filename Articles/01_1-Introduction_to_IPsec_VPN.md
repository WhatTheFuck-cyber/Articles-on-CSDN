...
## 1 简介
IPsec VPN 是基于 IPsec 协议实现的虚拟专用网络技术，通过对 IP 层会话数据进行加密与认证等操作，确保数据在网络传输过程中的机密性、完整性与时效性。需要注意的是，IPsec 实际上并不能隐藏通信双方的 IP 地址，但是能防止出现 IP 地址冒充的情况。
...
##### 3.2.2.1 投影坐标系计算
关于计算P3 = P1 + P2：
![示例图片](./assets/image_01/图片01_1--2.png)

##### 3.2.2.2 蒙哥马利算法
![示例图片](./assets/image_01/图片01_1--3.png)
![示例图片](./assets/image_01/图片01_1--4.png)
